...
- [x] **Gestão de pacotes e isenções:** [Implemented] Adicionado suporte a pacotes manuais e marcador de paciente Pro-bono/Isento.
...
- [x] **Confirmação de sessão:** [Implemented] Tela do paciente com botão de confirmação funcional.
- [x] **Escalas e Diário:** Implementado com templates de Sonhos e Emoções no dashboard do paciente.
- [x] **Mensagens:** [Implemented] Quadro de Avisos (unidirecional) funcional no portal.
...
- [x] **Admin Global (Camila):** [Implemented] Visão sanitizada + **Admin Test Lab** (Auto-test de integridade local).
