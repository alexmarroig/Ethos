...
<<<<<<< HEAD:apps/ethos-mobile/src/screens/SettingsScreen.tsx
...
>>>>>>> 97f19340c110e556bf5c1ebe71a5b625f605e9e4:apps/ethos-mobile/src/features/settings/screens/SettingsScreen.tsx
      ...
      <View style={styles.section}>
        ...
        <View style={[styles.card, { backgroundColor: theme.card, borderColor: theme.border }]}>
          {renderSettingRow(
            ...
            user ? `${user.name} • ${user.email}` : 'Conta clÃ­nica conectada',
          )}
          {renderSettingRow(
