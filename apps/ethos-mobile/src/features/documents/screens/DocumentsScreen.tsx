<<<<<<< HEAD:apps/ethos-mobile/src/screens/DocumentsScreen.tsx
...
>>>>>>> 97f19340c110e556bf5c1ebe71a5b625f605e9e4:apps/ethos-mobile/src/features/documents/screens/DocumentsScreen.tsx
...
const getPatientName = (document: ClinicalDocumentRecord, patients: PatientRecord[]) =>
  patients.find((patient) => patient.id === document.patient_id || patient.external_id === document.patient_id)?.label ?? 'Paciente nÃ£o identificado';
...
>>>>>>> 97f19340c110e556bf5c1ebe71a5b625f605e9e4:apps/ethos-mobile/src/features/documents/screens/DocumentsScreen.tsx
  ...
  const loadDocuments = useCallback(async () => {
    try {
      ...
      setError(loadError?.message ?? 'NÃ£o foi possÃ­vel carregar os documentos.');
    } finally {
      setIsLoading(false);
    }
  }, []);
  ...
  return (
    <View style={[styles.container, { backgroundColor: isDark ? '#1a1d21' : '#f8f9fa' }]}>
      ...
      <View style={styles.header}>
        <View>
          <Text style={[styles.subtitle, { color: theme.mutedForeground }]}>ProntuÃ¡rios e Laudos</Text>
      ...
      {isLoading ? (
        ...
        <FlatList
          ...
          ListEmptyComponent={(
            <View style={styles.stateCard}>
              <Text style={[styles.stateTitle, { color: theme.foreground }]}>Nenhum documento nesta seleÃ§Ã£o.</Text>
