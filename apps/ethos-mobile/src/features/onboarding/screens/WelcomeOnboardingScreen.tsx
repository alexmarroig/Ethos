...
export default function WelcomeOnboardingScreen({ navigation }: any) {
  ...
  return (
    <SafeAreaView
      style={[
        styles.container,
        { backgroundColor: isDark ? colors.dark.background : '#fcfcfb' },
      ]}
    >
      ...
      <View style={styles.header}>
        <View style={styles.headerLeft}>
          ...
          <Text style={[styles.headerBrand, { color: primaryTeal }]}>
            ETHOS
          </Text>
        </View>
      ...
      >
        <Animated.View entering={FadeIn.duration(800)} style={styles.welcomeSection}>
          ...
          <Text style={[styles.subtitle, { color: primaryTeal }]}>
            Sua plataforma clínica está pronta. Vamos começar a organizar seus
            atendimentos com ética e tecnologia?
          </Text>
        </Animated.View>
