        ...
        <SafeAreaView style={[styles.container, { backgroundColor: isDark ? colors.dark.background : '#fcfcfb' }]}>
            ...
            <View style={styles.progressSection}>
                <View style={styles.progressHeader}>
                    <Text style={[styles.progressTitle, { color: primaryTeal }]}>Especialidade e Ãƒâ€°tica</Text>
            ...
            <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                <Animated.View entering={FadeInDown.delay(200).duration(600)}>
                    ...
                    <Text style={[styles.subtitle, { color: theme.mutedForeground }]}>
                        Informe sua ÃƒÂ¡rea de atuaÃƒÂ§ÃƒÂ£o e aceite os termos ÃƒÂ©ticos da plataforma para garantir a conformidade clÃƒÂ­nica.
                    </Text>
                    ...
                    {/* Abordagem ClÃƒÂ­nica */}
                    <View style={styles.inputGroup}>
                        <Text style={[styles.inputLabel, { color: primaryTeal }]}>Abordagem ClÃƒÂ­nica</Text>
                        <TouchableOpacity style={[styles.dropdownWrapper, { backgroundColor: inputBg, borderColor: theme.border }]}>
                    ...
                    >
                        ...
                        <Text style={[styles.termsText, { color: primaryTeal }]}>
                            Li e concordo com o <Text style={styles.boldText}>CÃƒÂ³digo de Ãƒâ€°tica Profissional</Text> do PsicÃƒÂ³logo e os <Text style={styles.boldText}>Termos de Uso</Text> da plataforma ETHOS. Estou ciente do meu compromisso com o sigilo e a prÃƒÂ¡tica baseada em evidÃƒÂªncias.
                        </Text>
                    </TouchableOpacity>
