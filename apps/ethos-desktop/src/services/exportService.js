...
exports.exportClinicalNote = void 0;
...
const escapeXml = (value) => value
    ...
    .replace(/\"/g, "&quot;")
    .replace(/'/g, "&apos;");
const escapePdf = (value) => value.replace(/[()\\]/g, (match) => `\\${match}`);
const sanitizeFileName = (value) => value.replace(/[^a-zA-Z0-9-_]+/g, "_").toLowerCase();
...
const toUint16LE = (value) => new Uint8Array([value & 0xff, (value >>> 8) & 0xff]);
const toUint32LE = (value) => new Uint8Array([
    value & 0xff,
    (value >>> 8) & 0xff,
    (value >>> 16) & 0xff,
    (value >>> 24) & 0xff,
...
const exportClinicalNote = async (payload, format) => {
    ...
    downloadFile(new Blob([docx], { type: "application/vnd.openxmlformats-officedocument.wordprocessingml.document" }), `${baseName}.docx`);
    return `${baseName}.docx`;
};
exports.exportClinicalNote = exportClinicalNote;
